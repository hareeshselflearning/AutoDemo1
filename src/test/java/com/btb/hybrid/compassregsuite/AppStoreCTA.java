package com.btb.hybrid.compassregsuite;
...
public class AppStoreCTA extends BaseTest{
	@Test(dataProvider="getData")
	public void ctaAppStore(Hashtable<String,String> data) throws Exception{
		try {
		test.log(Status.INFO, "Starting "+ testCaseName+" - Test");
		test.assignAuthor("Author = Hareesh");
